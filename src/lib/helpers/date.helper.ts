...
export const formatDateLong = (dateString?: string, monthFormat: FormatMonth = 'long') =>
    formatDateGeneric(dateString, monthFormat, true);

export const formatDateShort = (dateString?: string, monthFormat: FormatMonth = 'short') =>
    formatDateGeneric(dateString, monthFormat, true);
