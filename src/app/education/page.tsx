    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="p-6 text-center hover:shadow-lg transition-all hover:-translate-y-1">
          ...
          <p className="text-3xl font-bold text-primary mb-2">{contentData.experience.length}+</p>
        ...
        <Card className="p-6 text-center hover:shadow-lg transition-all hover:-translate-y-1">
          ...
          <p className="text-3xl font-bold text-primary mb-2">{contentData.projects.length}+</p>
