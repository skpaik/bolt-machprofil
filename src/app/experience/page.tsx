    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                ...
                <Card
                    className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
                    {showLucidIcon('building2', 'w-8 h-8 mx-auto mb-3 text-blue-600 dark:text-blue-400')}
                    <div className="text-3xl font-bold mb-1">{experiences.length}</div>
                    <div className="text-sm text-muted-foreground">Companies</div>
                </Card>

                <Card
                    className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900">
                    {showLucidIcon('award', 'w-8 h-8 mx-auto mb-3 text-green-600 dark:text-green-400')}
                ...
                <Card
                    className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900">
                    {showLucidIcon('target', 'w-8 h-8 mx-auto mb-3 text-purple-600 dark:text-purple-400')}
                    <div className="text-3xl font-bold mb-1">
                        {experiences.reduce((sum, exp) => sum + (exp.projects?.length || 0), 0)}+
                    </div>
                        ...
                        <div key={exp.id} className="relative">
                            ...
                            <div
                                className={`hidden md:block absolute left-8 top-8 w-4 h-4 -ml-2 rounded-full border-4 border-background z-10 ${
                                    exp.current ? 'bg-primary animate-pulse' : 'bg-muted-foreground'
                                }`}/>
                            ...
                            <Card className={`md:ml-20 hover:shadow-lg transition-shadow ${
                                ...
                                {exp.current && (
                                    <div
                                        className="bg-primary text-primary-foreground text-xs font-semibold py-1 px-4 text-center flex items-center justify-center gap-1">
                                        ...
                                        <div className="flex-1">
                                            <div
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    <Badge variant={getEmploymentTypeColor(exp.employmentType) as any}>
                                                        {exp.employmentType}
                                                    </Badge>
                                        ...
                                        <ul className="space-y-2 ml-7">
                                            {exp.responsibilities.map((resp, idx) => (
                                                <li key={idx}
                                                    ...
                                                    {showLucidIcon('chevron-right', 'w-4 h-4 text-primary mt-0.5 flex-shrink-0')}
                                                    <span>{resp}</span>
                                                </li>
                                            ))}
                                        </ul>
