...
export default function ResumePage() {
  ...
  const summary = aboutContentData.intro ||
      ...
      <div className="min-h-screen bg-muted/30">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Professional CV & Portfolio</p>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print:p-0">
            ...
            <CardContent className="p-8 sm:p-12 space-y-8 print:p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start print:flex-row">
                ...
                <div className="flex-1">
                  <h1 className="text-4xl font-bold mb-2 print:text-3xl">{profile.name}</h1>
                  ...
                  <div className="grid sm:grid-cols-2 gap-2 text-sm">
                    ...
                    {profile.website && (
                        <div className="flex items-center gap-2">
                          ...
                          <a href={profile.website} className="hover:text-primary" target="_blank">
                    ...
                    {profile.linkedin && (
                        <div className="flex items-center gap-2">
                          ...
                          <a href={`https://${profile.linkedin}`} className="hover:text-primary" target="_blank">
                            {profile.linkedin}
                          </a>
                        </div>
                    )}
                    {profile.github && (
                        <div className="flex items-center gap-2">
                          ...
                          <a href={`https://${profile.github}`} className="hover:text-primary" target="_blank">
                            {profile.github}
                          </a>
                        </div>
                    )}
                          ...
                          <div key={exp.id} className="print:break-inside-avoid">
                            ...
                            {exp.responsibilities && exp.responsibilities.length > 0 && (
                                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-2">
                                  {exp.responsibilities.slice(0, 4).map((resp: string, idx: number) => (
                                      <li key={idx}>{resp}</li>
                                  ))}
                                </ul>
                            )}
              ...
              {experiences.length > 0 && <hr className="border-border print:hidden" />}
              ...
              {education.length > 0 && <hr className="border-border print:hidden" />}
              ...
              {Object.keys(groupedSkills).length > 0 && certificates.length > 0 && (
                  <hr className="border-border print:hidden" />
              )}
          ...
          <div className="print:hidden text-center text-sm text-muted-foreground mt-8 mb-4">
            ...
            <p className="mt-2">For the most up-to-date information, visit my website</p>
          </div>
        </div>
