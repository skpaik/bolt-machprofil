...
export default function HomePage() {
    ...
    const intro = aboutContentData.intro ||
    ...
    const tagline = aboutContentData.hero.tagline || 'Building Digital Experiences That Matter';
    ...
    const stats = useMemo(() => {
        ...
        const totalYears = experiences.length > 0 ? Math.floor(
        ...
        const uniqueClients = new Set(
            ...
            projects.filter((p: any) => p.client).map((p: any) => p.client)
        ).size;
        ...
        return {
            ...
            projects: completedProjects > 0 ? `${completedProjects}+` : `${projects.length}+`,
    ...
    const topServices = useMemo(() => {
        ...
        const skillCategories = [...new Set(skills.map((s: any) => s.category))].slice(0, 4);
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative">
                            <div className="relative w-full max-w-md mx-auto">
                                <div
                                    className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-primary/5 rounded-full blur-3xl"></div>
                                <img
                                    src={profile.image}
                                    alt={profile.name}
            ...
            <section className="bg-muted/50 py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div className="text-center">
                            <div className="text-4xl font-bold text-primary mb-2">{stats.projects}</div>
                            <div className="text-sm text-muted-foreground">Projects Completed</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-bold text-primary mb-2">{stats.clients}</div>
